...
var require_regeneratorRuntime = __commonJS({
  "node_modules/@babel/runtime/helpers/regeneratorRuntime.js"(exports, module) {
    ...
    function _regeneratorRuntime3() {
      ...
      var t, e = {}, r2 = Object.prototype, n = r2.hasOwnProperty, o2 = Object.defineProperty || function(t2, e2, r3) {
        t2[e2] = r3.value;
      ...
      function wrap(t2, e2, r3, n2) {
        ...
        return o2(a3, "_invoke", {
          value: makeInvokeMethod(t2, r3, c3)
        }), a3;
      }
      ...
      e.wrap = wrap;
      var h = "suspendedStart", l2 = "suspendedYield", f2 = "executing", s2 = "completed", y2 = {};
      function Generator() {
      }
      ...
      function makeInvokeMethod(e2, r3, n2) {
        ...
        return function(i3, a3) {
          ...
          for (n2.method = i3, n2.arg = a3; ; ) {
            ...
            o3 = f2;
            var p3 = tryCatch(e2, r3, n2);
            if ("normal" === p3.type) {
              if (o3 = n2.done ? s2 : l2, p3.arg === y2)
                continue;
              return {
                value: p3.arg,
                done: n2.done
            ...
            "throw" === p3.type && (o3 = s2, n2.method = "throw", n2.arg = p3.arg);
          }
        };
      }
      function maybeInvokeDelegate(e2, r3) {
        var n2 = r3.method, o3 = e2.iterator[n2];
        if (o3 === t)
          return r3.delegate = null, "throw" === n2 && e2.iterator["return"] && (r3.method = "return", r3.arg = t, maybeInvokeDelegate(e2, r3), "throw" === r3.method) || "return" !== n2 && (r3.method = "throw", r3.arg = new TypeError("The iterator does not provide a '" + n2 + "' method")), y2;
        var i3 = tryCatch(o3, e2.iterator, r3.arg);
        if ("throw" === i3.type)
          return r3.method = "throw", r3.arg = i3.arg, r3.delegate = null, y2;
        var a3 = i3.arg;
        return a3 ? a3.done ? (r3[e2.resultName] = a3.value, r3.next = e2.nextLoc, "return" !== r3.method && (r3.method = "next", r3.arg = t), r3.delegate = null, y2) : a3 : (r3.method = "throw", r3.arg = new TypeError("iterator result is not an object"), r3.delegate = null, y2);
      }
        ...
        if (e2 || "" === e2) {
          ...
          if (!isNaN(e2.length)) {
            var o3 = -1, i3 = function next2() {
              for (; ++o3 < e2.length; )
                if (n.call(e2, o3))
                  return next2.value = e2[o3], next2.done = false, next2;
      ...
      return GeneratorFunction.prototype = GeneratorFunctionPrototype, o2(g, "constructor", {
        ...
        configurable: true
      }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u2, "GeneratorFunction"), e.isGeneratorFunction = function(t2) {
        var e2 = "function" == typeof t2 && t2.constructor;
        return !!e2 && (e2 === GeneratorFunction || "GeneratorFunction" === (e2.displayName || e2.name));
      }, e.mark = function(t2) {
        return Object.setPrototypeOf ? Object.setPrototypeOf(t2, GeneratorFunctionPrototype) : (t2.__proto__ = GeneratorFunctionPrototype, define(t2, u2, "GeneratorFunction")), t2.prototype = Object.create(g), t2;
      }, e.awrap = function(t2) {
        return {
          __await: t2
        };
        ...
        return this;
      }), e.AsyncIterator = AsyncIterator, e.async = function(t2, r3, n2, o3, i3) {
        void 0 === i3 && (i3 = Promise);
        var a3 = new AsyncIterator(wrap(t2, r3, n2, o3), i3);
        return e.isGeneratorFunction(r3) ? a3 : a3.next().then(function(t3) {
        ...
        dispatchException: function dispatchException(e2) {
          ...
          function handle(n2, o4) {
            return a3.type = "throw", a3.arg = e2, r3.next = n2, o4 && (r3.method = "next", r3.arg = t), !!o4;
          }
...
SyntaxHighlighter2.registerLanguage = function(_2, language) {
...
var Code = class extends import_react5.PureComponent {
  constructor() {
    super(...arguments);
...
var ThemedCode = lt(Code);
var LANGUAGE_FALLBACK = "text";
var CodeBlock = class extends import_react5.PureComponent {
  constructor() {
    super(...arguments);
    this._isMounted = false;
...
var ThemedCodeBlock = lt(CodeBlock);
var ClipboardListIcon = ({
  size,
  color,
  ...props
}) => import_react5.default.createElement("svg", Object.assign({}, props, {
  viewBox: "0 0 384 512",
  width: size,
  height: size,
  fill: color
...
var usePortal = (selectId = getId()) => {
  ...
  const [elSnapshot, setElSnapshot] = (0, import_react5.useState)(isBrowser2 ? createElement2(id) : null);
  (0, import_react5.useEffect)(() => {
    const hasElement = document.querySelector(`#${id}`);
    const el = hasElement || createElement2(id);
    if (!hasElement) {
...
var useClipboard = (options = defaultOptions) => {
  ...
  const copy2 = (0, import_react5.useCallback)((text) => {
    copyText(el, text);
  }, [el]);
  return {
    copy: copy2
...
function CopyBlock({
  ...
  const [copied, toggleCopy] = (0, import_react5.useState)(false);
  const {
    copy: copy2
  } = useClipboard();
  const handler = (event) => {
  ...
  return import_react5.default.createElement(Snippet, Object.assign({}, {
    ...
    // @ts-ignore
    import_react5.default.createElement(CodeBlock, Object.assign({
      text,
      theme
    }, rest))
  ) : (
    // @ts-ignore
    import_react5.default.createElement(Code, Object.assign({
      text,
      theme
    }, rest))
  ), import_react5.default.createElement(Button, Object.assign({
    type: "button",
    onClick: handler
  }, {
    theme,
...
var ThemedCopyBlock = lt(CopyBlock);
...
var SnippetIcon$1 = import_react5.default.memo(SnippetIcon);
var SnippetWrapper = st.div`
    position: relative;
    width: ${({
  width
}) => !!width ? width : "auto"};
...
var Snippet$1 = ({
  ...
  const theme = (0, import_react5.useContext)(He);
  const style = (0, import_react5.useMemo)(() => !!theme && getStyles(theme), [theme]);
  const showCopyIcon = (0, import_react5.useMemo)(() => copyType !== "prevent", [copyType]);
  const childText = (0, import_react5.useMemo)(() => {
    if (isMultiLine)
  ...
  return import_react5.default.createElement(SnippetWrapper, Object.assign({
    className: `${className}`
  }, props, {
    style
  }), isMultiLine ? text.map((t, index) => import_react5.default.createElement("pre", {
    key: `snippet-${index}-${t}`
  }, t)) : import_react5.default.createElement("pre", {
    ref
  }, children || text), showCopyIcon && import_react5.default.createElement("div", {
    className: "copy",
    onClick: clickHandler
  }, import_react5.default.createElement(SnippetIcon$1, null)));
};
var MemoSnippet = import_react5.default.memo(Snippet$1);
var Snippet$2 = withDefaults(MemoSnippet, defaultProps);
var ThemedSnippet = lt(Snippet$2);
var a11yDark = {
